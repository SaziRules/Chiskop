...
<div className="grid grid-cols-1 md:grid-cols-2 md:items-center gap-10 md:gap-10 h-[60vh]">
  ...
  <div className="text-left md:pl-6">
    ...
    <button className="btn rounded-lg text-b2 font-extrabold uppercase">
      ...
      {/* ───────────── Mobile Swipe Section (final two-line heading fix) ───────────── */}
<div className="md:hidden overflow-hidden pl-5">
  <div className="flex overflow-x-auto snap-x snap-mandatory space-x-5 px-3 scroll-smooth pb-5">
    {/* Card 1 */}
<div className="shrink-0 w-[82%] snap-start bg-white flex flex-col items-start">
  <div className="bg-[#f6f6f6] w-full aspect-[1/1.2] p-6 flex items-center justify-center mb-3">
    <Image
      src="/images/hair-removal.png"
      alt="Hair Removal Cream"
      width={260}
  ...
  <div className="w-full">
    <h2
      className="uppercase text-chiskop-black font-extrabold text-[28px] leading-[1.1] tracking-tight mb-1 text-left max-w-[280px] truncate-lines-2"
    >
      Hair Removal Cream
    </h2>

    <div className="relative h-[5px] w-[50px] mb-2">
      <div className="absolute inset-0 bg-linear-to-r from-chiskop-black to-transparent" />
      <div className="absolute bottom-0 left-0 w-[50px] h-[5px] bg-white/40 blur-[0.5px]" />
    </div>

    <p className="text-[12px] text-chiskop-black leading-snug mb-2 text-left max-w-[220px]">
      Quick, easy &amp; pain-free hair removal in 7 minutes
    </p>

    <button className="btn rounded-sm text-[11px] px-4 py-1.5 font-extrabold uppercase">
      Shop Now
    </button>
  </div>
</div>
    ...
    <div className="shrink-0 w-[82%] snap-start bg-white flex flex-col items-start">
      ...
      <div className="w-full">
        <h2
          className="uppercase text-chiskop-black font-extrabold text-[28px] sm:text-menu leading-[1.03] tracking-tight mb-1 text-left max-w-[280px] truncate-lines-2"
        >
          Soothing Balm &amp; Aftershave
        </h2>
